...
class TableWidget_LGE(QTableWidget):
    def __init__(self, parent=None):
        super(TableWidget_LGE, self).__init__(parent=parent)
...
class LabelTableWidget(TableWidget_LGE):
    def __init__(self, parent=None):
        super(LabelTableWidget, self).__init__(parent=parent)
        print('GT')

class NormTableWidget(TableWidget_LGE):
    def __init__(self, parent=None):
        super(NormTableWidget, self).__init__(parent=parent)
        print('Norm')

class LightTableWidget(TableWidget_LGE):
    def __init__(self, parent=None):
        super(LightTableWidget, self).__init__(parent=parent)

class ROITableWidget(TableWidget_LGE):
    def __init__(self, parent=None):
