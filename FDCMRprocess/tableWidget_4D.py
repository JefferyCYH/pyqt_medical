...
class TableWidget_4D(QTableWidget):
    def __init__(self, parent=None):
        super(TableWidget_4D, self).__init__(parent=parent)
    ...
    def update_item(self):
        ...
        self.mainwindow.useListWidget_LGE.currentItem().update_params(param)
...
class LabelTableWidget(TableWidget_4D):
    def __init__(self, parent=None):
        super(LabelTableWidget, self).__init__(parent=parent)
        print('GT')

class NormTableWidget(TableWidget_4D):
    def __init__(self, parent=None):
        super(NormTableWidget, self).__init__(parent=parent)
        print('Norm')

class LightTableWidget(TableWidget_4D):
    def __init__(self, parent=None):
        super(LightTableWidget, self).__init__(parent=parent)

class ROITableWidget(TableWidget_4D):
    def __init__(self, parent=None):
        super(ROITableWidget, self).__init__(parent=parent)

class RegTableWidget(TableWidget_4D):
    def __init__(self, parent=None):
        super(RegTableWidget, self).__init__(parent=parent)

class SegTableWidget(TableWidget_4D):
    def __init__(self, parent=None):
